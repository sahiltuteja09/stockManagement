...
const routes: Routes = [
  ...
  { path: 'khata', loadChildren: './pages/khata/khata.module#KhataPageModule',  data: { num: 250 }  },
  { path: 'mykhatas', loadChildren: './pages/khata/mykhatas/mykhatas.module#MykhatasPageModule',  data: { num: 251 }  },
  { path: 'khataview', loadChildren: './pages/khata/khataview/khataview.module#KhataviewPageModule',  data: { num: 252 }  },
  { path: 'addcustomer', loadChildren: './pages/khata/addcustomer/addcustomer.module#AddcustomerPageModule',  data: { num: 253 }  },
  { path: 'addkhata', loadChildren: './pages/khata/addkhata/addkhata.module#AddkhataPageModule',  data: { num: 254 }  },
  { path: 'purchasesview', loadChildren: './pages/purchases/purchasesview/purchasesview.module#PurchasesviewPageModule',  data: { num: 255 }  },
